					...
					<?php foreach( $this->get( 'items', [] ) as $id => $item ) : ?>
						...
						<tr class="list-item <?= $this->site()->mismatch( $item->getSiteId() ) ?>">
							...
							<?php if( in_array( 'order.datepayment', $fields ) ) : ?>
								<td class="order-datepayment"><a class="items-field" href="<?= $url ?>"><?= $enc->html( \App\Support\AsaanDate::formatString( $item->getDatePayment() ) ) ?></a></td>
							<?php endif ?>
							...
							<?php if( in_array( 'order.datedelivery', $fields ) ) : ?>
								<td class="order-datedelivery"><a class="items-field" href="<?= $url ?>"><?= $enc->html( \App\Support\AsaanDate::formatString( $item->getDateDelivery() ) ) ?></a></td>
							<?php endif ?>
							...
							<?php if( in_array( 'order.ctime', $fields ) ) : ?>
								<td class="order-ctime"><a class="items-field" href="<?= $url ?>"><?= $enc->html( \App\Support\AsaanDate::formatString( $item->getTimeCreated() ) ) ?></a></td>
							<?php endif ?>
							<?php if( in_array( 'order.mtime', $fields ) ) : ?>
								<td class="order-mtime"><a class="items-field" href="<?= $url ?>"><?= $enc->html( \App\Support\AsaanDate::formatString( $item->getTimeModified() ) ) ?></a></td>
							<?php endif ?>
