					...
					<div class="col-xl-12">
						<div class="box">
							<div class="row">
								...
								<div class="col-xl-6">
									<div class="form-group row optional">
										<label class="col-sm-4 form-control-label help"><?= $enc->html( $this->translate( 'admin', 'Date format' ) ) ?></label>
										<div class="col-sm-8">
											<select class="form-select item-date-mode" tabindex="1"
												name="<?= $enc->attr( $this->formparam( array( 'item', 'locale.site.config', 'date', 'customer-mode' ) ) ) ?>" >
												<option value="afghan" <?= $selected( $this->get( 'itemData/locale.site.config/date/customer-mode' ), 'afghan' ) ?> >
													<?= $enc->html( $this->translate( 'admin', 'Afghan (Solar Hijri)' ) ) ?>
												</option>
												<option value="dual" <?= $selected( $this->get( 'itemData/locale.site.config/date/customer-mode' ), 'dual' ) ?> >
													<?= $enc->html( $this->translate( 'admin', 'Afghan + Gregorian' ) ) ?>
												</option>
												<option value="gregorian" <?= $selected( $this->get( 'itemData/locale.site.config/date/customer-mode' ), 'gregorian' ) ?> >
													<?= $enc->html( $this->translate( 'admin', 'Gregorian' ) ) ?>
												</option>
											</select>
										</div>
										<div class="col-sm-12 form-text text-muted help-text">
											<?= $enc->html( $this->translate( 'admin', 'Date format shown to customers in the shop' ) ) ?>
										</div>
									</div>
								</div>
							</div>
