...
$dateMode = $this->config( 'date/customer-mode', 'afghan' );
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="order-created row">
										...
										<span class="value col-7">
											<?= $enc->html( \App\Support\AsaanDate::formatString( $orderItem->getTimeCreated(), $dateMode ) ) ?>
										</span>
									</div>
								</div>
							</div>
									...
									<div class="order-payment row">
										...
										<span class="value col-7">
											<?php if( ( $date = $orderItem->getDatePayment() ) !== null ) : ?>
												...
												<?= $enc->html( sprintf( $attrformat, $paystatus, \App\Support\AsaanDate::formatString( $date, $dateMode ) ), $enc::TRUST ) ?>
											<?php endif ?>
										</span>
									</div>
								</div>
									...
									<div class="order-delivery row">
										...
										<span class="value col-7">
											<?php if( ( $date = $orderItem->getDateDelivery() ) !== null ) : ?>
												...
												<?= $enc->html( sprintf( $attrformat, $status, \App\Support\AsaanDate::formatString( $date, $dateMode ) ), $enc::TRUST ) ?>
											<?php endif ?>
										</span>
									</div>
								</div>
